          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login">
                <br>
                <img src="PICTURE/logo.jpg" class="rounded mx-auto d-block position-static" width="110%">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">C&C Jewerly Invoice System</h1>
                  </div>

                  <form class="validate-form" method="POST">
                    <div class="form-group validate-input" data-validate="Employee Id is required">
                      <input type="text" class="form-control form-control-user" id="username" name="username" aria-describedby="emailHelp" placeholder="Enter Employee Id..." required>
                    </div>
