      ...
      <hr>
              ...
              <div class="card-body card-body-cascade ">
                ...
                <table class="table table-striped  leaveSta " width="100%" cellspacing="0">
                    ...
                    <!-- <tbody class=" output " id="output"> -->
                        <tbody>
                            <td class="table-danger"><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="description" name="description"> </td>
                            <td class="table-danger"><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="unitPrice" name="unitPrice"> </td>         
                            <td class="table-danger"><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="grams" name="grams"> </td>
                            <td class="table-danger"><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="totalPrice" name="totalPrice" > </td>   
                            
                        </tbody>
                        <tbody>
                            <td><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="" name=""disabled> </td>
                            <td><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="" name=""disabled> </td>         
                            <td><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="" name=""disabled> </td>
                            <td><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="" name=""disabled> </td>   
                        ...
                        <tbody>
                            <td class="table-danger"><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="" name=""disabled> </td>
                            <td class="table-danger"><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="" name=""disabled> </td>         
                            <td class="table-danger"><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="" name=""disabled> </td>
                            <td class="table-danger"><input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="" name=""disabled> </td>   
                        ...
                        <tbody>
                            ...
                            <td> </td>         
                            <td> </td>
                            <td><input type="number" class="form-control border-top-0 border-right-0 border-left-0 " id="shipping" name="shipping"> </td>   
                        ...
                        <td class="table-danger"><h4 for="validationDefault01" class="form-label"><b>Insurance</b></h4></td>
                            ...
                            <td class="table-danger"> </td>
                            <td class="table-danger"><input type="number" class="form-control border-top-0 border-right-0 border-left-0 " id="insurance" name="insurance"> </td>   
            ...
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                <div class="form-row">
                    ...
                    <div class="col-md-3">
                        <input type="number" class="form-control border-top-0 border-right-0 border-left-0 " id="subtotal" name="subtotal" placeholder="" >
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3">
                        <input type="number" class="form-control border-top-0 border-right-0 border-left-0 " id="deposit" name="deposit" placeholder="" >
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3">
                        <input type="number" class="form-control border-top-0 border-right-0 border-left-0 " id="discount" name="discount" placeholder="" >
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-5">
                        <input type="number" class="form-control border-top-0 border-right-0 border-left-0 " id="totalAmount" name="totalAmount" placeholder="" >
                    </div>
