...
<!-- Page Heading -->
<br>
<h1 class="h3 mb-2 text-gray-800"> <i class=" fas fa-search" aria-hidden="true"></i> Today`s Invoice </h1>
<br>
<hr>
<!-- DataTales Example -->
<div class="card shadow mb-4 ">
    ...
    <div class="table-responsive">
        ...
        <a name="fetch" id="fetch" value="" class="btn btn-info btn-lg"><i class=" fas fa-view" aria-hidden="true">View Today`s Transaction</i> </a>
...
$(document).ready(function() {
  ...
  $('#fetch').click(function() {
    ...
    $.ajax({
      ...
      url: "assets/fetch_today_transaction_query.php",  // Set the URL of the script to be called on the server-side (likely fetches data)
